...
```python
from  torrentlib import check_trackers, check_tracker, CheckTracker
timeout = 5  # seconds
...
```python
from  torrentlib import query, TrackerEvent, TrackerQueryException
