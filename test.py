# from bt_tracker_utils import CheckTracker, check_trackers, TorrentStatus, check_tracker, Query
...
result = tracker.Query.single(torrent, 'https://tracker.ghostchu-services.top:443/announce',
            "-robots-testing12345")
